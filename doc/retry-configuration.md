...
func main() {
    retryConfiguration := shutterstockapiexplorer.CreateRetryConfiguration(
        shutterstockapiexplorer.WithMaxRetryAttempts(0),
        shutterstockapiexplorer.WithRetryOnTimeout(true),
        shutterstockapiexplorer.WithRetryInterval(1),
        shutterstockapiexplorer.WithMaximumRetryWaitTime(0),
        shutterstockapiexplorer.WithBackoffFactor(2),
        shutterstockapiexplorer.WithHttpStatusCodesToRetry([]int64{408, 413, 429, 500, 502, 503, 504, 521, 522, 524, 408, 413, 429, 500, 502, 503, 504, 521, 522, 524}),
        shutterstockapiexplorer.WithHttpMethodsToRetry([]string{"GET", "PUT", "GET", "PUT"}),
    )
}
```
